    ...
    <body class="overflow-x-hidden bg-background font-body-md text-on-background">
        ...
        <main class="relative flex min-h-screen items-center justify-center overflow-hidden pt-16">
            <div class="pointer-events-none absolute inset-0 z-0">
                <div class="absolute left-[-10%] top-[-10%] h-[80%] w-[60%] rounded-full bg-primary-container/10 blur-[120px]"></div>
                <div class="absolute bottom-[-10%] right-[-10%] h-[70%] w-[50%] rounded-full bg-secondary-fixed/5 blur-[100px]"></div>
            ...
            <div class="relative z-10 my-12 w-full max-w-[520px] px-[20px]">
                <div class="group relative overflow-hidden rounded-xl border border-white/5 bg-surface-container p-8 shadow-2xl backdrop-blur-sm md:p-10">
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="relative">
                                ...
                                <input
                                    ...
                                    class="w-full rounded-lg border border-outline-variant bg-surface-container-low py-4 pl-12 pr-12 text-on-surface outline-none transition-all focus:border-transparent focus:ring-2 focus:ring-secondary-fixed"
                                >
                                <button type="button" data-password-toggle="password_confirmation" class="absolute right-3 top-1/2 -translate-y-1/2 rounded p-1 text-outline transition hover:text-secondary-fixed focus:outline-none focus:ring-2 focus:ring-secondary-fixed" aria-label="Tampilkan kata sandi" title="Tampilkan kata sandi">
                                    <span class="material-symbols-outlined">visibility</span>
                                </button>
                            </div>
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <button type="button" data-dev-toast="Google signup sedang dikembangkan." class="flex items-center justify-center gap-2 rounded-lg border border-outline-variant bg-surface-container-low py-3 font-label-bold text-label-bold transition-colors hover:bg-surface-container-high">
                        ...
                        <button type="button" data-dev-toast="Apple signup sedang dikembangkan." class="flex items-center justify-center gap-2 rounded-lg border border-outline-variant bg-surface-container-low py-3 font-label-bold text-label-bold transition-colors hover:bg-surface-container-high">

...
<html class="dark" lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>SmashCourt | Payment Return</title>
    ...
    <body class="min-h-screen bg-[#111316] text-white">
        <main class="mx-auto flex min-h-screen max-w-xl items-center px-6 py-10">
            <div class="w-full rounded-3xl border border-white/10 bg-[#1a1c1f] p-8 shadow-2xl shadow-black/20">
                <p class="text-sm font-semibold uppercase tracking-[0.25em] text-[#c3f400]">Midtrans Return</p>
                <h1 class="mt-3 text-3xl font-extrabold uppercase tracking-tight">Status Tersinkron</h1>
                <p class="mt-4 text-sm leading-7 text-slate-300">
                    Halaman ini mengirim update status pembayaran ke tab utama SmashCourt. Kamu bisa kembali ke tab sebelumnya untuk melihat hasil terbaru.
                </p>

                <div class="mt-8 rounded-2xl border border-white/10 bg-[#1e2023] px-5 py-5">
                    <p class="text-xs font-semibold uppercase tracking-[0.22em] text-slate-400">Payment Status</p>
